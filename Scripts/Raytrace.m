...
SV1 = ctd(1).Sound_velocity;
SV2 = ctd(2).Sound_velocity;
SV3 = ctd(3).Sound_velocity;
SV4 = ctd(4).Sound_velocity;
SV5 = ctd(5).Sound_velocity;
SV6 = ctd(6).Sound_velocity;
SV7 = ctd(7).Sound_velocity;
SV8 = ctd(8).Sound_velocity;
...
function [xxf, zzf, ttf, ddf] = traceray(xo,zo, theta0,tt,zz,cc,plotflag)
    ...
    %[x z t d] = traceray(0,0,5,120,zz,cc,true);
